 ...
 * Exported functions:
 * HISTORY:
 * Last edited: Nov 27 13:45 2024 (rd109)
...
typedef struct {
  ...
  Array    count ;   // of I64 (fast ONEcode read/write) 
} KmerHash ;
...
char*     kmerHashSeq (KmerHash *kh, I64 i) ; // retrieve the i'th sequence (rev-comp'd if i < 0)
